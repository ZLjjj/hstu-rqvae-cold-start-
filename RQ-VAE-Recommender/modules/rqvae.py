...
class RqVae(nn.Module, PyTorchModelHubMixin):
    def __init__(
        ...
        codebook_ema_eps: float = 1e-5,
        codebook_dead_code_threshold: float = 1.0,
        codebook_dead_code_reset: bool = False,
        n_layers: int = 3,
        ...
        self.layers = nn.ModuleList(modules=[
            Quantize(
                ...
                ema_eps=codebook_ema_eps,
                dead_code_threshold=codebook_dead_code_threshold,
                dead_code_reset=codebook_dead_code_reset,
